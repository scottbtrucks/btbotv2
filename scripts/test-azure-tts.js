...
/**
 * Test script for Azure Text-to-Speech service
 * 
 * This script tests the Azure TTS service directly using the same parameters
 * as our updated implementation.
 */
...
const text = 'Привет, это тест Azure Text-to-Speech сервиса.';
const outputFile = path.join(process.cwd(), 'azure-tts-test.wav');
